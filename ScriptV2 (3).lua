...
Bindable.OnInvoke = function(button)
    if button == "Copy Link" then
        ...
        if setclipboard then
            setclipboard("https://discord.gg/Bk73CjuRFy")
        end
...
game.StarterGui:SetCore("SendNotification", {
    Title = "UgPhone Mod",
    Text = "UgPhone Vô Hạn Free Nếu Cần Thì Vào Nhóm Discord Tải Nha",
    Duration = 10,
    Button1 = "Copy Link",
    Button2 = "Close",
    Callback = Bindable
...
imageButton.Image = "rbxassetid://80845703924287"
